...
if ($availableProfiles.Count -gt 0) {
    Write-Host "
Starting MCP services with profiles: $($availableProfiles -join ', ')" -ForegroundColor Green
    ...
    Write-Host "
No MCP services have the required API keys. Please set the environment variables and try again." -ForegroundColor Red
    Write-Host "
Required environment variables:" -ForegroundColor Yellow
